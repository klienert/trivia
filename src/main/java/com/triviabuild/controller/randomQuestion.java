...
/**
 * The type Random question.
 */
@WebServlet(
        urlPatterns = {"/randomQuestion"}
)
/**
...
public class randomQuestion extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (score > 0) {
            req.setAttribute("score", "<span class=\"text-success\">" + score + "</span");
        } else if (score < 0) {
            req.setAttribute("score", "<span class=\"text-danger\">" + score + "</span");
        } else {
